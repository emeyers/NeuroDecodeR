...
test_that("can create and add objects to an ndr container", {
  ...
  updated_ndr_container <- add_ndr_object(the_ndr_container, ds) 
  ...
  expect_warning(add_ndr_object(updated_ndr_container, ds))
  
  # test that I can add multiple feature preprocessors to the ndr container
  fp <- fp_zscore()
  updated_ndr_container <- add_ndr_object(updated_ndr_container, fp) 
  updated_ndr_container <- add_ndr_object(updated_ndr_container, fp) 
