...
following code shows how to create this binned data. For more information about
...
the classifier was trained and tested with data that was that come from different
locations.
