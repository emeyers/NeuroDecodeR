...
The following datasets can be used with the NDTr to learn how to use the package.
...
The Zhang-Desimone 7 object dataset comes with the NDTr. Individual raster files
can be found in the directory `extdata/Zhang_Desimone_7object_raster_data_rda/`.
Additionally, binned data using 150 ms bins and 50 ms sampling intervals can be
found in the file `extdata/ZD_150bins_50sampled.Rda`. The code below shows how
to load a single raster data file, and the binned data.
...
lab](http://neuroscience.graduate.wfu.edu/people/christos-constantinidis/) in
