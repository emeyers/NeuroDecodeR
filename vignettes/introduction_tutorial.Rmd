...
Below, we visualize the spiking pattern for this one neuron.
...
The NDTr decoding objects operate on data in binned-format. To convert
...
Finally, the NDTr has a "log" function that helps you save and manage your results.
