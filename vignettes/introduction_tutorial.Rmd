...
Below we visualize the spiking pattern from this one neuron.
...
Below we use the plot function associated with the results that are returned to
...
We also create simpler line plots by setting the `plot_type = 'line'`.
