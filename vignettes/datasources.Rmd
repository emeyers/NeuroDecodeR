...
Datasources are used to generate training and tests splits of data. All datasources must implement a get_data() method that returns a data frame that has the following variables in it: 
